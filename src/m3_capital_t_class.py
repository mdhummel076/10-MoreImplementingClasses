...
class CapitalT(object):
    ...
    *** See the PDFs, especially dimensions.pdf, to help you understand this.
    ...
    def clone(self):
        ...
        letterWidth = self.v_rect.corner_2.x-self.v_rect.corner_1.x
        height = self.v_rect.corner_2.y-self.v_rect.corner_1.y
        width = self.h_rect.corner_2.x-self.h_rect.corner_1.x

        newT = CapitalT(rg.Point(self.v_rect.corner_1.x+letterWidth/2,self.v_rect.corner_1.y+letterWidth/2),width,height,letterWidth)

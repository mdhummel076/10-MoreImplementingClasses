...
class Line(object):
    ...
    def __init__(self, start, end):
        ...
        self.end = end.clone()
        self.cloneCount = 0
        self.orStart = start.clone()
        self.orEnd = end.clone()
    ...
    def line_plus(self, other_line):
        ...
        sumLine = Line(self.start.plus(other_line.start),self.end.plus(other_line.end))
        return sumLine
    ...
    def line_minus(self, other_line):
        ...
        diffLine = Line(self.start.minus(other_line.start), self.end.minus(other_line.end))
        return diffLine
